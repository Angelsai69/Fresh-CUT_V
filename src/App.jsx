...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* ── FLOATING AI BUTTON — breathing pulse ── */}
      <motion.div
        style={{
          position: 'fixed',
          bottom: 100, right: 20,
      ...
      >
        {/* Breathing ring — slow sine pulse, released on hover/tap */}
        <motion.div
          ...
          style={{
            ...
            borderRadius: tokens.radius.full,
            background: 'radial-gradient(circle, rgba(255,107,107,0.55) 0%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
        {/* Button */}
